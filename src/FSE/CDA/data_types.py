...
class ST_String(Component):
    def __init__(self, name: str, data: str):
        ...
        if type(data) != str:
            raise InvalidGivenValue(f"{name} must be a string")
        elif data == "":
            raise InvalidGivenValue(f"{name} can not be empty string")
        else:
            self.text = data
...
class CD_ConceptDescriptor(Component):
    def __init__(self, name: str, data: dict):
        ...
        self.originalText = el.Component("originalText", ST_String, data)
        self.translaction = el.Component("translaction", CD_ConceptDescriptor, data)
